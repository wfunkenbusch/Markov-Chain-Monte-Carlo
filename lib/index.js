...
class Graph {
  ...
  generate() {
    ...
    */
    ...
    do {
      var rand1 = Math.floor(this.G.nodes().length * Math.random());
      var rand2;
      do {
        // Selects two random nodes
        rand2 = Math.floor(this.G.nodes().length * Math.random());
  ...
  iterate() {
    ...
    New graph is stored as this.H. q(i|j)/q(j|i) is stored as this.qrat.
    */
  ...
  theta(G, r) {
    ...
    r - 
    Relative weight of edges, scaled to the shortest path weight.
